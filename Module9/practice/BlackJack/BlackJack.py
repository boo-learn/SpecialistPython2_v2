...
while True:
    ...
    print(f'Карты дилера: {[str(card) for card in dealer_cards]}')
    print(f'Ваши карты: {[str(card) for card in player_cards]}')
    ...
    if sum_points(dealer_cards) < sum_points(player_cards) < 21:
        print(f'Карты дилера: {[str(card) for card in dealer_cards]}')
        print(f'Ваши карты: {[str(card) for card in player_cards]}')
        print(f'Ваши очки {sum_points(player_cards)}')
