...
class Book:
    ...
    def to_str(self):
        ...
        res = '"' + self.name + '" author:' + self.author.short_name() + ' publish:' + str(self.year) + ' год'
        return res
...
print(book.to_str())
author = Author("Василий", "Демидов")
book = Book("Метель", author, 1926, 25)
print(book.to_str())
