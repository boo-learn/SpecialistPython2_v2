...
class Fraction:
    ...
    def __add_sub_helper(self, other):
        ...
        common_divisor = gcd(self.denominator, other.denominator)
        left_operand = self.numerator * (common_divisor / self.denominator)
        right_operand = other.numerator * (common_divisor / other.denominator)
        return common_divisor, int(left_operand), int(right_operand)
