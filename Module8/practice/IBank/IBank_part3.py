...
class Operation:
    ...
    def __init__(self, oper_type: str, amount: int, commission = ''):
    ...
    def __repr__(self) -> None:
        ...
        """
        return f'{self.type} {self.amount} руб. {self.commission}'.strip()
...
class Account:
    ...
    def withdraw(self, amount: int) -> None:
        ...
        if self.__balance - amount < 0:
            ...
            self.__balance -= amount
            self.__history.append(Operation('Снятие', amount, f'(комиссия {amount * 0.02} руб.)'))
    ...
    def transfer(self, target_account: 'Account', amount: int) -> None:
        ...
        if self.__balance - amount < 0:
            ...
            self.__history.append(Operation(f'Перевод на счет клиента {target_account.name}', amount, f'(комиссия {amount * 0.02} руб.)'))
