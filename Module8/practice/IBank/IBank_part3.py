...
class Account:
    ...
    def __init__(self, name: str, passport: str, phone_number: str, start_balance: int = 0, bank_comission: int = 0):
        self.name = name
    ...
    def bank_comission(self, amount):
        value_comission = (amount*Account.COMISSION_RATE)/100
        return round(value_comission)
    ...
    def withdraw(self, amount: int, bank_comission, to_history: bool = True) -> None:
        if self.__balance < (amount + bank_comission):
