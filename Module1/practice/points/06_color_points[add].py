...
print("Площадь красного треугольника = ", abs(((red[0].x - red[2].x) * (red[1].y - red[2].y) - (red[1].x - red[2].x) * (red[0].y - red[2].y)) * 0.5))
print("Площадь зеленого треугольника = ", abs(((green[0].x - green[2].x) * (green[1].y - green[2].y) - (green[1].x - green[2].x) * (green[0].y - green[2].y)) * 0.5))
