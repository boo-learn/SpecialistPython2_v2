...
class Triangle:
    ...
    def area(self):
        ...
        p = (self.point1.dist_to(self.point2) + self.point2.dist_to(self.point3) + self.point3.dist_to(self.point1)) \
            / 2
        return (p * (p - self.point1.dist_to(self.point2)) * (p - self.point2.dist_to(self.point3)) *
                (p - self.point3.dist_to(self.point1))) ** 0.5
        # (p*(p-a)*(p-b)*(p-c))**0.5
