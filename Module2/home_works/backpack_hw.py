...
class BackPack:  # рюкзак
    ...
    def add_item(self, items_list: list[Item]) -> None:
    ...
    def __find_max_value_item(self, items_list: list) -> Item:
        ...
        max_value = max(items_by_value.values())  # find max value
        for item in items_by_value.keys():  # find item with max value
            if item.get_value() == max_value:
                return item  # return max value item
