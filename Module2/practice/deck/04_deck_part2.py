...
class Card:
    ...
    def more(self, other_card):
        if self.card_type != other_card.card_type:
            return Card.cardtype_weight[self.card_type] > Card.cardtype_weight[other_card.card_type]
        else:
            return Card.suittype_weight[self.suit_type] > Card.suittype_weight[other_card.suit_type]
