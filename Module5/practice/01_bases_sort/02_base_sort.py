...
def gen_list(size, at=-100, to=100):
    ...
    """
    return [random.randrange(at, to) for i in range(size)]
...
lst_choice = sort_choice(my_lst)
print('Сортировка выбором\n', lst_choice)

lst_bubble = bubble_sort(my_lst)
print('Сортировка пузырьками\n', lst_bubble)

lst_quick = quick_sort(my_lst)
