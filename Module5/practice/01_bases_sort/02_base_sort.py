    ...
    while swapped:
        ...
        for i in range(len(nums) - j):
            ...
            if nums[i] > nums[i + 1]:
                ...
                swapped = True
        j += 1
    print("after bubblesort = ", nums)


def sort_choice(nums):
    print("before choice sort = ", nums)
    i = 0
    while i < len(nums) - 1:
        m = i
        j = i + 1
        ...
        i += 1
    print("after choice sort = ", nums)


def quick_sort(nums):
    print("before quick sort = ", nums)
...
def gen_list(size, at=-100, to=100):
    import random
    return [random.randrange(at, to) for _ in range(0, size)] # честно спиратил в интернете, но мне он не нравится
    """
...
lst = gen_list(10, -50, 50)
print(bubble_sort(lst))
lst = gen_list(10, -50, 50)
print(sort_choice(lst))
lst = gen_list(10, -50, 50)
