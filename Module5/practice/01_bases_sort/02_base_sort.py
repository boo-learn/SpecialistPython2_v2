...
gen = gen_list(100)
sort_c = sort_choice(gen)
print(f'Массив отсортированный алгоритмом выбора {sort_c}')
sort_b = bubble_sort(gen)
print(f'Массив отсортированный алгоритмом пузырька {sort_b}')
sort_q = quick_sort(gen)
print(f'Массив отсортированный алгоритмом quick {sort_q}')
